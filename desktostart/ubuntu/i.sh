...
to_install=(
    ...
    # node js
    'if nvm --version;then echo "nvm installed";else curl https://raw.githubusercontent.com/creationix/nvm/v0.32.1/install.sh | bash && source ~/.profile;sudo chmod -R 777 ~/.nvm;source .bashrc;fi;'
